...
const translations = {
  es: {
    ...
    faq: {
      ...
      a3: "Sí. Tenemos ministerio para niños y espacios donde pueden aprender de la Biblia.",
      q4: "¿Puedo asistir aunque nunca haya ido a una iglesia?",
      a4: "Claro que sí. Te recibimos con amor y puedes venir como estás.",
      q5: "¿Cómo puedo pedir oración?",
      a5: "En la sección de ayuda puedes enviar tu solicitud o escribirnos por WhatsApp.",
      q6: "¿Cómo puedo unirme a un ministerio?",
      a6: "Visita la sección de ministerios y escríbenos por WhatsApp para coordinar.",
    },
    fab: {
