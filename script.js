...
const translations = {
  es: {
    ...
    menu: {
      ...
      ministriesDesc: "Encuentra donde servir.",
      helpDesc: "Pide oracion o apoyo.",
    ...
    somos: {
      ...
      description:
        "Somos una familia de fe que abre la Biblia, adora a Dios y sirve con amor.",
      item1Title: "Palabra",
    ...
    scripture: {
      ...
      description:
        "Ven como estas. Queremos caminar contigo y apuntarte a Cristo.",
      cta: "Quiero visitar",
  ...
  en: {
    ...
    somos: {
      ...
      description:
        "We are a family of faith that opens the Bible, worships God and serves with love.",
      item1Title: "Word",
    ...
    scripture: {
      ...
      description:
        "Come as you are. We want to walk with you and point you to Christ.",
      cta: "I want to visit",
