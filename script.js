...
const translations = {
  es: {
    ...
    eventos: {
      ...
      item2Desc: "Apoyo en oracion, viveres y visitas.",
    ...
    ayuda: {
      ...
      formNote: "Se guarda para revision y se abre WhatsApp para coordinar.",
      privacyNote:
