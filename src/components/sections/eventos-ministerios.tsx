        ...
        <Reveal>
          ...
          <button
            ...
            className={cn(
              ...
              "btn-skeuo mt-8 h-12 rounded-full px-6 font-semibold focus-visible:ring-2 focus-visible:ring-white"
            )}
          >
            {t("eventos.item1Link")}
          </button>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
              ...
              <Reveal key={ministry.id} delay={index * 0.04}>
                <Card className="surface-porcelain h-full gap-0 ring-0">
                  <CardContent className="flex items-start gap-4 p-5 sm:p-6">
                    <span
                      className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#65101a] text-white"
                      aria-hidden
                    >
        ...
        <Reveal className="mt-10">
          <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
            <p className="font-heading text-lg font-semibold text-[#f0d2b8]">
            ...
            <a
              ...
              className={cn(
                buttonVariants({ size: "lg" }),
                "btn-skeuo h-11 rounded-full px-5 font-semibold text-white hover:text-white focus-visible:ring-2 focus-visible:ring-shekinah"
              )}
            >
