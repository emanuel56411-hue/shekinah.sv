        ...
        {items.map((item, index) => {
          ...
          const content = (
            <>
              <span
                aria-hidden
                className="absolute inset-x-0 top-0 h-[3px] bg-[#f4a8b1]/80 transition-colors duration-200 group-hover:bg-[#f4a8b1]"
              />
              <div className="flex items-start justify-between gap-3">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/5 text-[#f4a8b1] transition-colors duration-200 group-hover:border-[#f4a8b1]/50 group-hover:bg-[#65101a] group-hover:text-white">
                  <Icon className="h-[1.1rem] w-[1.1rem]" strokeWidth={1.5} />
                </span>
                <ArrowUpRight
                  className="h-4 w-4 shrink-0 text-white/35 transition-all duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-[#f4a8b1]"
                  strokeWidth={1.5}
                  aria-hidden
                />
              </div>
              <div>
                <span className="text-[0.68rem] font-bold uppercase tracking-[0.16em] text-[#f4a8b1]">
                  {item.title}
                </span>
