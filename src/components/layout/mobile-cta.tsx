...
export function MobileCta() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-3 border-t border-black/20 bg-white/45 backdrop-blur md:hidden"
    >
      <Link
        href="#reuniones"
      ...
      <Link
        href="#ubicacion"
        className="border-x border-black/15 px-3 py-3 text-center text-sm font-medium text-foreground transition-colors hover:text-shekinah focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-shekinah  "
      >
