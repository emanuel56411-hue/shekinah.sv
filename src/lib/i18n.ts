...
export const translations: Record<Lang, TranslationTree> = {
  es: {
    ...
    ayuda: {
      ...
      emptyRequestsTitle: "Aún no hay solicitudes públicas",
      emptyRequestsDesc: "Cuando se apruebe una solicitud, aparecerá aquí. También puedes pedir apoyo con el formulario.",
  ...
  en: {
    ...
    ayuda: {
      ...
      emptyRequestsTitle: "No public requests yet",
      emptyRequestsDesc: "Approved requests will appear here. You can also ask for support with the form.",
