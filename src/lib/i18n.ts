...
export const translations: Record<Lang, TranslationTree> = {
  es: {
    ...
    pastor: {
      ...
      emptyTitle: "Pronto habrá una palabra nueva",
      emptyDesc: "Cuando el pastor publique un versículo, oración, foto o video, aparecerá aquí.",
      emptyCta: "Pedir oración",
      menuSoonClose: "Entendido",
    ...
    galeria: {
      ...
      item1Title: "Culto en familia",
      item2Tag: "Niños",
      item2Title: "Nueva generación",
      item3Tag: "Gratitud",
      item3Title: "Aniversario",
      item4Tag: "Comunión",
      item4Title: "Unidad",
      item5Tag: "Palabra",
      item5Title: "Predicación",
      item6Tag: "Enseñanza",
      item6Title: "Estudio bíblico",
      item7Tag: "Familia",
      item7Title: "Momentos",
    },
    reuniones: {
    ...
    ubicacion: {
      ...
      description: "Te esperamos para adorar juntos.",
      mapsBtn: "Google Maps",
      wazeBtn: "Waze",
    ...
    ayuda: {
      ...
      submittedWhatsappOnly: "Se abrió WhatsApp. Si no se abrió, revisa que WhatsApp esté instalado.",
      whatsappError: "No se pudo abrir WhatsApp. Intenta de nuevo o escríbenos al número de la iglesia.",
      optionalFields: "Teléfono (opcional)",
  ...
  en: {
    ...
    galeria: {
      ...
      item1Title: "Family worship",
      item2Tag: "Children",
      item2Title: "Next generation",
      item3Tag: "Gratitude",
      item3Title: "Anniversary",
      item4Tag: "Fellowship",
      item4Title: "Unity",
      item5Tag: "Word",
      item5Title: "Preaching",
      item6Tag: "Teaching",
      item6Title: "Bible study",
      item7Tag: "Family",
      item7Title: "Moments",
    },
    reuniones: {
    ...
    ubicacion: {
      ...
      description: "We look forward to worshiping with you.",
      mapsBtn: "Google Maps",
      wazeBtn: "Waze",
      whatsappBtn: "WhatsApp",
      mapsHint: "Open route",
    ...
    ayuda: {
      ...
      submittedWhatsappOnly: "WhatsApp opened. If it did not open, check that WhatsApp is installed.",
      whatsappError: "WhatsApp could not be opened. Try again or call the church number.",
      optionalFields: "Phone (optional)",
